  ...
  return (
    <div>
      <div className="explanation">
        ...
        <p>
          <strong>Custom Hooks</strong> are JavaScript functions that start with "use" and may call other React Hooks. 
          They allow you to extract component logic into reusable functions, making your code more modular and easier to test.
        </p>
...
// - Response.ok: Checking HTTP status`}
      ...
      <div className="example">
        ...
        <p>Custom hook for tracking window dimensions with debounced updates.</p>
        <WindowSizeExample />
        <div className="code-block">
...
// - Cleanup Functions: Preventing memory leaks`}
      ...
      <div className="example">
        ...
        <p>Custom hook for form management with validation and submission handling.</p>
        <FormExample />
        <div className="code-block">
...
// - Conditional Logic: Form validation`}
      ...
      <div className="js-concept">
        ...
        <ul>
          <li><strong>Function Composition:</strong> Combining multiple React hooks into custom logic</li>
          <li><strong>State Management:</strong> Managing local state with useState</li>
          <li><strong>Side Effects:</strong> Handling external interactions with useEffect</li>
          <li><strong>Async/Await:</strong> Handling asynchronous operations in hooks</li>
          <li><strong>Error Handling:</strong> Try/catch blocks for robust error management</li>
          <li><strong>Event Listeners:</strong> addEventListener, removeEventListener for DOM events</li>
          <li><strong>localStorage API:</strong> Persistent storage in the browser</li>
          <li><strong>JSON Methods:</strong> parse() and stringify() for data serialization</li>
          <li><strong>Fetch API:</strong> Making HTTP requests from hooks</li>
          <li><strong>Debouncing:</strong> setTimeout/clearTimeout for performance optimization</li>
          <li><strong>Object Methods:</strong> Object.keys() for iteration and validation</li>
          <li><strong>Computed Properties:</strong> Dynamic property names with bracket notation</li>
          <li><strong>Function Types:</strong> instanceof Function for type checking</li>
...
function LocalStorageExample() {
  ...
  return (
    <div>
      ...
      <p><small>Try refreshing the page - the values will persist!</small></p>
    </div>
  );
}
  ...
  return (
    <div>
      ...
      <input
        ...
        className="input"
      />
      <button onClick={refetch} className="button">Refetch</button>
...
function WindowSizeExample() {
  ...
  return (
    <div>
      ...
      <p><small>Try resizing your browser window to see the updates!</small></p>
    </div>
  );
}
      ...
      <form onSubmit={(e) => { e.preventDefault(); handleSubmit(onSubmit); }}>
        <div>
          ...
          {touched.name && errors.name && (
            <p style={{ color: '#e74c3c', fontSize: '0.8rem' }}>{errors.name}</p>
          )}
        </div>
        ...
        <div>
          ...
          {touched.email && errors.email && (
            <p style={{ color: '#e74c3c', fontSize: '0.8rem' }}>{errors.email}</p>
          )}
        </div>
        ...
        <div>
          ...
          {touched.password && errors.password && (
            <p style={{ color: '#e74c3c', fontSize: '0.8rem' }}>{errors.password}</p>
          )}
        </div>
